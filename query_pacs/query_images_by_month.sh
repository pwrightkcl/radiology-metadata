#!/bin/bash
# Query PACS for months of image data based on saved study indices
...
mkdir -p "/home/pwright/data/responses/images"
...
do
  ...
  uv run "$query_script" by_study \
    ...
    --output_dir "/home/pwright/data/responses/images/radiology_gstt_images_${yearmonth}" \
    --query_level "image" \
    --chunk_size 20000 \
